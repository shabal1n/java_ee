            ...
            <div class="col-lg-7">
                <div class="banner_text">
                    <div class="banner_text_iner">
                        ...
                        <h1>Modern restaurants of Almaty</h1>
                ...
                <div class="client_review_part owl-carousel">
                    <div class="client_review_single">
                        <div class="client_review_text">
                            ...
                            <div class="client_review_img">
                                <img src="${pageContext.request.contextPath}/resources/img/client/client_1.png"
                                     alt="#"/>
                                <h4>Mosan Cameron</h4>
                    ...
                    <div class="client_review_single">
                        <div class="client_review_text">
                            ...
                            <div class="client_review_img">
                                <img src="${pageContext.request.contextPath}/resources/img/client/client_2.png"
                                     alt="#"/>
                                <h4>Mosan Cameron</h4>
                                <div class="review_icon">
                                    <i class="fas fa-star"></i>
                    ...
                    <div class="client_review_single">
                        <div class="client_review_text">
                            ...
                            <div class="client_review_img">
                                <img src="${pageContext.request.contextPath}/resources/img/client/client_3.png"
                                     alt="#"/>
                                <h4>Mosan Cameron</h4>
                                <div class="review_icon">
                                    <i class="fas fa-star"></i>
            ...
            <div class="col-lg-6">
                <div class="contact_part_iner">
                    ...
                    <div class="single_contact_part">
                        <h5>address</h5>
                        <p>152, KARASAY BATYR STR, ALMATY, KAZAKHSTAN</p>
                    </div>
                    <div class="single_contact_part">
                        <h5>WE ARE OPEN</h5>
                    ...
                    <div class="single_contact_part">
                        <h5>RESERVATION</h5>
                        <p>+7 708 909 90 18</p>
                        <span>artur.shab@yandex.ru</span>
                    </div>
                </div>
            </div>
        </div>
