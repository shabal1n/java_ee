                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-6">
                            <div class="single_food_item media">
                                <img src="resources/img/food_menu/single_food_1.png"
                            ...
                            <div class="single_food_item media">
                                <img src="resources/img/food_menu/single_food_2.png"
                                     class="img-responsive" alt="...">
                                <div class="media-body align-self-center">
                            ...
                            <div class="single_food_item media">
                                <img src="resources/img/food_menu/single_food_3.png"
                                     class="img-responsive" alt="...">
                                <div class="media-body align-self-center">
                        ...
                        <div class="col-sm-6 col-lg-6">
                            <div class="single_food_item media">
                                <img src="resources/img/food_menu/single_food_4.png"
                                     class="img-responsive" alt="...">
                                <div class="media-body align-self-center">
                            ...
                            <div class="single_food_item media">
                                <img src="resources/img/food_menu/single_food_5.png"
                                     class="img-responsive" alt="...">
                                <div class="media-body align-self-center">
                            ...
                            <div class="single_food_item media">
                                <img src="resources/img/food_menu/single_food_6.png"
                                     class="img-responsive" alt="...">
                                <div class="media-body align-self-center">
                                    <h3>Chicken Roast</h3>
                                    <p>They're wherein heaven seed hath nothing</p>
